...
public class TodoListSQLHelper extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "com.mio.jrdv.copyemails";
    public static final String TABLE_NAME = "COPY_EMAILS";
    public static final String COL1_TASK = "name";
    public static final String COL2_TASK = "email";
